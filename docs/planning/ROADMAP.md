...
- **Feedback-pipeline evolution (5 specs, S1→S5)** — turn the printer-intake pipeline from
  ...
  **ALL 5 specs + 5 plans now QA-green** (each run write→sub-agent-review→patch→QA, autonomous 2026-06-15;
  ...
  - **S3** Scout dedupe/triage robustness — brand-alias/fuzzy + model-suffix-strip (absorbs **Scout
    finding 1**) + a versioned **learned-guardrails config** the deterministic Scout reads. Web/script. `[automation]`
