...
| **Export** | Engine + bridge done. Web UI **live for Bambu printers behind a Beta badge** (↓ Process + ↓ Filament JSON downloads in the results header; non-Bambu printers get ↓ Copy-as-text). iOS UI **hidden** (deferred post-release). Full slicer-export activation is spec'd as IMPL-043 (`docs/specs/IMPL-043-slicer-export-activation.md`; Phase 0 golden files are owner homework). |
