...
| ~~#039~~ | ~~Printer-capability clamping + slicer-aware values~~ | **✅ Shipped 2026-04-20** — web `TBD`, iOS `TBD` (see Completed phases). |
|---|---------|-------|-------|
