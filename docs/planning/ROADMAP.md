...
| **iOS app** | v1.0.3 live worldwide on App Store, dark mode only (since 2026-05-11, build `202605101637`). **v1.0.4 SUBMITTED for review 2026-05-20** — build `202605192119` (run [26125919796](https://github.com/mustiodk/3dprintassistant-ios/actions/runs/26125919796)), Manual Release; awaiting Apple approval. Remote printer overlay `content_version=2026051202` is live (i7 under Creality / i Series) for current 1.0.3 clients without a new binary; v1.0.4 bakes i7 into the bundled catalog. EU unblocked 2026-04-27. |
...
## Active Release: v1.0.4 (in App Store review) — v1.0.3 batch shipped

**v1.0.4** (accuracy/honesty release) submitted for App Store review 2026-05-20, build `202605192119`, Manual Release — awaiting Apple approval. See the **Last updated** banner above + the v1.0.4 SHIPPED entry in Active Work Queue for the full arc. The v1.0.3 batch below is the prior shipped release, retained for history.
