...
**v1.0.4** (accuracy/honesty release) is **LIVE on the App Store** — submitted 2026-05-20 (build `202605192119`, Manual Release), owner-confirmed approved + live 2026-06-04; now the live build, supersedes 1.0.3. See the **Last updated** banner above + the v1.0.4 SHIPPED entry in Active Work Queue for the full arc. The v1.0.3 batch below is the prior shipped release, retained for history.
