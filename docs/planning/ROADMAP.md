...
**Last updated:** 2026-05-13 — v1.0.3 is live on the App Store; remote overlay `content_version=2026051202` ships i7 under Creality / i Series for current iOS clients. v1.0.4 S3 (impl) complete: web `bf05586` ships Task 4 (physical printer × plate guard + material plate range, HIGH-02 + HIGH-03 material half) on top of S2's Tasks 1-3. 5 cumulative v1.0.4 walkthrough OK lines; 47196/0 broad audit. iOS untouched (Phase 2 gated). **Next step:** S4 cold-starts and executes Task 5 (practical multicolor tiers — 5-tier resolver across 4 engine sites).
