...
- G0 harness baselines (`node scripts/<s>.js 2>&1 | shasum -a 256`):
  ...
  - matrix-audit `e0b72fd5fa67a3ecdfa9f38db5e7df5475c3854301775c614f8067c8de7ec0d6`
